...
### Changed
- Added label-driven stable release automation with a shared version resolver, PR release preview workflow, merge-to-main auto-tag workflow, and updated release policy documentation.
